...
def load_system_prompts():
    ...
    try:
        ...
        logger.error(f"[load_system_prompts]在解释提示词系统时出错，{str((e))}")
        raise e
...
def load_rag_prompts():
    ...
    try:
        ...
        logger.error(f"[load_rag_prompts]在解释RAG总结提示出错，{str((e))}")
        raise e
...
def load_report_prompts():
    ...
    try:
        ...
        logger.error(f"[load_report_prompts]在解释报告生成提示词出错，{str((e))}")
        raise e
