...
from utils.prompts_loader import load_system_prompts, load_report_prompts
...
@dynamic_prompt
async def areport_prompt_switch(request: ModelRequest):  # 动态切换提示词
    is_report = request.runtime.context.get("report", False)
    if is_report:
        return load_report_prompts()
